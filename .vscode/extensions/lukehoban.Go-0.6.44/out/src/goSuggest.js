...
var GoCompletionItemProvider = (function () {
    ...
    GoCompletionItemProvider.prototype.provideCompletionItemsInternal = function (document, position, token, config) {
        ...
        return this.ensureGoCodeConfigured().then(function () {
            return new Promise(function (resolve, reject) {
                ...
                return _this.runGoCode(filename, inputText, offset, inString, position, lineText).then(function (suggestions) {
                    if (!autocompleteUnimportedPackages) {
                        return resolve(suggestions);
                    }
                    // Add importable packages matching currentword to suggestions
                    suggestions = suggestions.concat(_this.getMatchingPackages(currentWord));
                    ...
                    if (suggestions.length === 0 && lineTillCurrentPosition.endsWith('.')) {
                        ...
                        if (pkgPath_1) {
                            ...
                            return _this.runGoCode(filename, inputText, offset, inString, position, lineText).then(function (newsuggestions) {
    ...
    GoCompletionItemProvider.prototype.runGoCode = function (filename, inputText, offset, inString, position, lineText) {
        return new Promise(function (resolve, reject) {
    ...
    GoCompletionItemProvider.prototype.getMatchingPackages = function (word) {
        if (!word)
            return [];
