...
let doOcpIndent = (code, token, range) => __awaiter(this, void 0, void 0, function* () {
...
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('ocaml.switch_mli_ml', () => __awaiter(this, void 0, void 0, function* () {
        ...
        if (!newExt) {
            yield vscode.window.showInformationMessage('Target file must be an OCaml signature or implementation file');
            return;
        }
        ...
        if (!(yield fsExists(newPath))) {
            ...
            yield vscode.window.showInformationMessage(`${name} file doesn't exist. New file has created for you.`);
        }
    ...
    context.subscriptions.push(vscode.commands.registerCommand('ocaml.utop', () => __awaiter(this, void 0, void 0, function* () {
        if (utopTerm) {
            utopTerm.dispose();
        }
    ...
    context.subscriptions.push(vscode.commands.registerCommand('ocaml.utop_send', () => __awaiter(this, void 0, void 0, function* () {
        if (!utopTerm) {
            utopTerm = vscode.window.createTerminal('OCaml UTop');
            utopTerm.sendText('utop', true);
        ...
        utopTerm.show(!configuration.get('ocaml.utopFocus', false));
        let editor = vscode.window.activeTextEditor;
        if (!editor)
            return;
        let selection = editor.document.getText(editor.selection);
        utopTerm.sendText(selection, configuration.get('ocaml.utopNewline', true));
    })));
    ...
    let lintDocument = (document) => {
        ...
        document[LINTER_DEBOUNCE_TIMER] = setTimeout(() => __awaiter(this, void 0, void 0, function* () {
            ...
            let diagnostics = yield provideLinter(document, document[LINTER_TOKEN_SOURCE].token);
